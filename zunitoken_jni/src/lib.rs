...
use zunitoken_primitives::serialization::{read_fr_repr_be, read_fr_vec};
use zunitoken_primitives::verifier::{TruncatedVerifyingKey, verify_proof};
...
#[no_mangle]
pub extern "system" fn Java_com_decentralchain_zunitoken_bls12_Groth16_verify(env: JNIEnv,
                                             class: JClass,
                                             jvk: jbyteArray,
                                             jproof: jbyteArray,
                                             jinputs: jbyteArray)
